...
The app includes multiple help points in the interface and a vignette documenting how to load data and the basic clustering loop -- see [vignette("visxhclust")](https://rhenkin.github.io/visxhclust/articles/visxhclust.html).
