...
dmat <- compute_dmat(numeric_data, "euclidean", "z-scores")
...
```{r gapstat}
gap_results <- compute_gapstat(scale_data(numeric_data), clusters)
...
```{r dunn}
res <- compute_metric(scale_data(numeric_data), clusters, "Dunn")
